...
namespace TheXEffect.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (await _dbContext.Users.AnyAsync(x => x.UserName.ToLower() == Input.UserName))
            {
                ModelState.AddModelError(nameof(Input.UserName), "Username not available");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user, new Claim(UserClaims.DefaultCalendarGoal, ""));
